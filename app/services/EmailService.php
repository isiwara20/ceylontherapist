...
class EmailService
{
    ...
    public function __construct()
    {
        ...
        $this->fromAddress = (string)env('MAIL_FROM_ADDRESS', 'no-reply@ceylontherapist.lk');
        $this->fromName = (string)env('MAIL_FROM_NAME', 'Ceylon Therapist');
        $this->logFile = $base . '/storage/logs/mail.log';
    }
