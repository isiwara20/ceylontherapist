...
<div class="admin-card">
    <form action="<?= baseUrl('admin/packages/create.php') ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid-3">
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" class="admin-input" min="0" step="0.01" placeholder="e.g. 22500.00" value="<?= e(post('price', '')) ?>">
