...
<head>
    ...
    <!-- Favicon / Title Logo -->
    <link rel="icon" type="image/png" href="<?= assetUrl('images/branding/logo.png') ?>">
    <link rel="shortcut icon" type="image/png" href="<?= assetUrl('images/branding/logo.png') ?>">
    <link rel="apple-touch-icon" href="<?= assetUrl('images/branding/logo.png') ?>">
    ...
    <!-- Common Stylesheets -->
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/reset.css') ?>">
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/variables.css') ?>">
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/typography.css') ?>">
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/header.css') ?>">
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/footer.css') ?>">
    
    <!-- Page Specific Stylesheet -->
    <?php if (!empty($pageCss)): ?>
        <link rel="stylesheet" href="<?= baseUrl($pageCss) ?>">
    <?php endif; ?>

    <!-- Responsive Breakpoints Stylesheet -->
    <link rel="stylesheet" href="<?= baseUrl('assets/css/common/responsive.css') ?>">
</head>
...
<header class="public-header" id="site-header">
    <div class="header-container container">
        <a href="<?= baseUrl('index.php') ?>" class="brand-logo" aria-label="Ceylon Therapist Home" style="display:inline-flex;align-items:center;max-height:56px;overflow:hidden;flex-shrink:0;">
            <img src="<?= assetUrl('images/branding/logo.png') ?>" alt="Ceylon Therapist Logo" class="brand-logo-img" style="height:52px;max-height:52px;width:auto;max-width:200px;object-fit:contain;display:block;">
        </a>
        ...
        <nav class="public-nav" id="public-nav">
            <ul class="nav-list">
                ...
                <li class="nav-item"><a href="<?= baseUrl('packages.php') ?>" class="nav-link <?= (basename($_SERVER['PHP_SELF'] ?? '') === 'packages.php' || basename($_SERVER['PHP_SELF'] ?? '') === 'package.php') ? 'active' : '' ?>">Packages</a></li>
